                ...
                items(levelStatistics) { levelStatistic ->
                    Card(Modifier.padding(12.dp)) {
                        Column(Modifier.padding(12.dp)) {
                            Text("Difficulty: ${levelStatistic.difficulty} Level: ${levelStatistic.songName}")
                            Text("Date: ${levelStatistic.date} Points: ${levelStatistic.points}")
                            Text("Tiles detail information")
                            Text("Max Combo: ${levelStatistic.maxCombo}")
                            Text("Perfect: ${levelStatistic.perfect}")
                            Text("Great: ${levelStatistic.great}")
                            Text("Good: ${levelStatistic.good}")
                            Text("Missed: ${levelStatistic.missed}")
                            Button(onClick = { levelStatisticviewModel.delete(levelStatistic) }) {
